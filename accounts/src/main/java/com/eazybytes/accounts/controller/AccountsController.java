...
public class AccountsController {
     ...
     * @return A ResponseEntity containing a ResponseDto with HTTP status and message
     */
    @PostMapping("/create")
    ...
    /**
     * Endpoint to get contact information details.
     *
     * @return A ResponseEntity containing a string with the contact information or
     *         HTTP status 500 with an ErrorResponseDto in case of an error.
     */
    @Operation(
